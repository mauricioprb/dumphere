...
const en = {
    ...
    'locked.submit': 'Enter',
    'claim.heading': 'The address /{prefix} is yours',
    'claim.body':
        'Choose an owner password. It opens the settings for this address, and you never receive a copy of it anywhere.',
    'claim.label': 'Owner password',
    'claim.confirmLabel': 'Repeat the password',
    'claim.submit': 'Save password',
    'claim.alreadyClaimed': 'This address already has an owner password.',
    'claim.toManage': 'Go to the page',
    'claim.recoveryHint': 'If you forget it, the Stripe receipt in your inbox lets you set a new one.',
    'buy.title': 'Buy',
    'buy.subtitle': 'One-time payment. The address becomes yours.',
    'buy.never': 'The page stops expiring. Today it disappears after 30 days without visits.',
    'buy.yours': 'The address /{prefix} is reserved for you. Nobody else can buy it.',
    'buy.nested': 'It covers everything under it: /{prefix}/notes, /{prefix}/meeting, and so on.',
    'buy.readonly': 'You can make the page read-only, to share it without risking edits.',
    'buy.password': 'You can set a visitor password and close the page to everyone else.',
    'buy.once': 'No subscription, no renewal. You pay once.',
    'buy.terms': 'For as long as the service exists.',
    'buy.confirm': 'Go to payment',
    'buy.confirmWithPrice': 'Pay {price}',
    'ownership.buy': 'Buy this address',
    'ownership.buyTitle': 'Buy /{prefix} — the address becomes yours and never expires',
    ...
    'recover.body':
        'Paste the Stripe receipt link for this purchase. It is in the receipt email and stays available in your account.',
    'recover.prefix': 'Which address you bought',
    'recover.receipt': 'Stripe receipt link',
    'recover.prefixHint': 'Just the start of the address, no slashes. For example: my-page.',
    'recover.receiptHint':
        'Search your email for the Stripe receipt, open it, and copy the address of the receipt page.',
