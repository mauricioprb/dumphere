...
const en = {
    ...
    'claim.pendingHeading': 'Payment for /{prefix} is processing',
    'claim.pendingBody': 'This page will update automatically as soon as the payment is confirmed.',
    'claim.body':
    ...
    'claim.recoveryKey': 'Recovery key',
    'claim.recoveryHint': 'Save this key now. It is the only way to change your password if you forget it.',
    'buy.title': 'Buy',
    ...
    'buy.nested': 'Create pages under it, such as /{prefix}/notes and /{prefix}/meeting.',
    'buy.limit': 'Includes up to {count} pages in total, counting /{prefix}.',
    ...
    'ownership.buyTitle': 'Buy /{prefix} and keep the address from expiring due to inactivity',
