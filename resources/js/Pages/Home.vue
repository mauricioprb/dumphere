            ...
            <div class="max-w-4xl w-full text-center space-y-5 sm:space-y-8">
                ...
                <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 p-5 sm:p-8 space-y-4 sm:space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <button
                            @click="goToDocument"
                            class="px-6 py-2.5 sm:py-3 bg-primary-600 text-white font-semibold rounded-lg hover:bg-primary-700 dark:bg-primary-500 dark:hover:bg-primary-600 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-neutral-900"
                        >
                            {{ t('home.openButton') }}
                        </button>
                    </div>
